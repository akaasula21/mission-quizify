...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        # Step 1: Initialize DocumentProcessor and Ingest Documents from Task 3
        processor = DocumentProcessor()
        processor.ingest_documents()

        # Step 2: Initialize the EmbeddingClient from Task 4 with embed config
        embed_client = EmbeddingClient(**embed_config)

        # Step 3: Initialize the ChromaCollectionCreator from Task 5
        ...
        with st.form("Load Data to Chroma"):
            ...
            topic_input = st.text_input("Quiz Topic", "Enter the topic of the quiz")
            ...
            if submitted:
                # Step 5: Use the create_chroma_collection() method to create a Chroma collection from the processed documents
